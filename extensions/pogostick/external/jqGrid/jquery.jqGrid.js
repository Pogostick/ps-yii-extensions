function jqGridInclude( sPath )
{
    var pathtojsfiles = sPath + '/js/'; // need to be ajusted
...
function parseQuery()
{
	...
	var sQuery = oMyScript.src.replace(/^[^\?]+\??/,'');
