...
Menu.prototype.drilldown = function(container, options) {
	...
	var checkMenuHeight = function(el) {
		...
		if ( options.firstMaxHeight != 0 )
		{
			el.height( options.firstMaxHeight );
			topList.height( options.firstMaxHeight );
			return;
		}

		if ( el.height() > max_height ) {
			el.removeClass('fg-menu-scroll').addClass('fg-menu-scroll');
		...
		options.firstMaxHeight = topList.height();
	};
...
Menu.prototype.setPosition = function(widget, caller, options) { 
	...
	var maxHeight = ( yVal - options.maxHeight ) + ( breadcrumb.getTotalHeight() * 2 );
