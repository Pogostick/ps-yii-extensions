...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row sticky">
		<?php echo $form->labelEx($model,'databaseComponent'); ?>
		<?php echo $form->textField($model,'databaseComponent', array('size'=>65)); ?>
		<div class="tooltip">
		This is the database component to use for this model.
		</div>
		<?php echo $form->error($model,'databaseComponent'); ?>
	</div>
	<div class="row sticky">
