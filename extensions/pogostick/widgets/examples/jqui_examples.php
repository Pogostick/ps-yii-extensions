 ...
 * @version 	SVN: $Id: jqui_examples.php 363 2010-01-03 19:05:32Z jerryablan@gmail.com $
 * @since 		v1.0.2
 *  
 * @filesource
 */
...
//	Create an accordian...
CPSjqUIWrapper::create( 'accordion', array( 'header' => 'h3', 'theme' => CPSjqUIWrapper::getCurrentTheme() ) );
...
?>
	...
	<h1>Welcome to jQuery UI Widgets for Yii!</h1>
	<p style="font-size: 1.3em; line-height: 1.5; margin: 1em 0; ">This page demonstrates the widgets available in Yii from JQuery UI when using the Pogostick Yii Extensions library. </p>
