 ...
 * @version 	SVN: $Id: CPSjqSelectMenu.php 369 2010-01-22 20:43:49Z jerryablan@gmail.com $
 * @since 		v1.0.5
 *  
 * @filesource
 */
class CPSjqSelectMenu extends CPSjQueryWidget
{
	...
	*/
	public function registerClientScripts( $bLocateScript = false )
	{
		...
		$this->pushScriptFile( $this->baseUrl . '/ui.selectmenu.js', CClientScript::POS_END );
