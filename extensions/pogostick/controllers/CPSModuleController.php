 ...
 * @subpackage Controllers
 */
abstract class CPSModuleController extends CController
{
	//********************************************************************************
	//* Constants
	//********************************************************************************
	...
	*/
	...
	/**
	* @var string Indexes into {@link CPSModuleController:m_arUserActionMap}
	*/
	...
	* @param CModel The model to send. If null, the model will be loaded.
	* @param string The name of the variable to pass to the view. Defaults to 'model'
	*/
	public function genericAction( $sActionId, $oModel = null, $sModelVarName = 'model' )
	{
		$this->render( $sActionId, array( $sModelVarName => ( $oModel ) ? $oModel : $this->loadModel() ) );
	}
	...
	*/
	public function actionCreate()
	{
		...
		if ( ! $this->saveModel( $_oModel, $_POST ) ) $this->genericAction( 'create', $_oModel );
	}
	...
	*/
	public function actionUpdate()
	{
		...
		if ( ! $this->saveModel( $_oModel, $_POST ) ) $this->genericAction( 'update', $_oModel );
	}
	...
	*/
	public function actionList()
	{
		...
		$this->render( 'list', array( 'models' => $_arModels, 'pages' => $_oPage ) );
	}
	...
	*/
	public function actionAdmin()
	{
		...
		$this->render( 'admin', array( 'models' => $_arModels, 'pages' => $_oPage, 'sort' => $_oSort, 'result' => $_oResult ) );
	}
	...
	* Maps to {@link CEZPostController::adminCommandMap} and calls the appropriate method.
	* 
	* @returns mixed
	*/
	...
	*/
	...
	{
		if ( isset( $arData[ $this->m_sModelName ] ) )
		{
