<?php
/**
* CPSCodeTableCommand class file.
*
* @filesource
...
*/
class CPSCodeTableCommand extends CPSModelCommand
{
	//********************************************************************************
	//* Constants
	//********************************************************************************
	...
	*/
	...
	/***
	* The name of our initial table population data
	*/
	...
	*/
	public function run( $arArgs )
	{
		...
		{
			echo "\033[1mError\033[0m: regular expressions not valid for this command.\n";
			return;
		}

		$this->displayParameters( 'Code Table Generator', array( 'Output Path' => $_sBasePath ) );
...
EOD;
	...
	*/
	public function getHelp()
	{
		...
		return <<<EOD
USAGE
	\033[1mpscodetable\033[0m <\033[1mclass-name\033[0m> [\033[1mtable-name\033[0m] [options]
