...
/**
 * IPSRest defines the interface for all REST type objects
 *
 * @package 	psYiiExtensions
 * @subpackage	base
 *
 * @author 		Jerry Ablan <jablan@pogostick.com>
 * @version 	SVN $Id: IPSRest.php 395 2010-07-15 21:34:48Z jerryablan@gmail.com $
 * @since 		v1.1.0
 *
 * @filesource
 */
class IPSRest extends IPSBase
{
}
